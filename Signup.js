                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control" placeholder="User Email" aria-label="Username" aria-describedby="addon-wrapping"/>
                                </div>
                                <div class="input-group flex-nowrap">
                                    <input type="text" class="form-control" placeholder="USER PASSWORD" aria-label="Recipient's username" aria-describedby="addon-wrapping" />
                                    </div>

                            </div>
                            <div >
                                <div className="btn-class">
                                <Link to='/notifier' style={{ display: 'flex', textDecoration: "none" } }><button type="button" class="btn btn-secondary btn-lg" style={{ width: '100%', display: "flex", justifyContent: "center" }}>SIGN UP</button></Link>
